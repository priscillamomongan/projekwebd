...
<div class="payment-success-popup page--popup" id="payment-success">
    ...
    <p class="popup--subtitle">Transaksi Berhasil</p>
    <p class="popup--note">Kembali Ke Menu Home Untuk Kembali Berbelanja</p>
    <a href="index.php" class="btn button m-button">Return to Home</a>
  </div>
